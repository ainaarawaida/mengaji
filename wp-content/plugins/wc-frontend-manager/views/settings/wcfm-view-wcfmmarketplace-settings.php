...
$mobile_banner_help_text = __( 'This Banner will be visible when someone browse Page from Mobile.', 'wc-frontend-manager' ) . ' ' . sprintf(
  ...
  <div class="wcfm-page-headig">
	...
	<div class="wcfm-collapse-content">
	  ...
	  <div class="wcfm-container wcfm-top-element-container">
	  	<h2><?php _e('Page Settings', 'wc-frontend-manager' ); ?></h2>
	  ...
	  <form id="wcfm_settings_form" class="wcfm">
			...
			<div class="wcfm-tabWrap">
				...
				<div class="page_collapsible" id="wcfm_settings_dashboard_head">
					...
					<?php _e('Page', 'wc-frontend-manager'); ?><span></span>
				</div>
					  ...
					  <div class="wcfm_clearfix"></div>
						...
						<div class="store_address">
						  ...
						  $settings_fields_general = apply_filters( 'wcfm_marketplace_settings_fields_general', array(
						  	                                        "store_name"  => array('label' => __('Page Name', 'wc-frontend-manager') , 'type' => 'text', 'class' => 'wcfm-text wcfm_ele wcfm_name_input', 'label_class' => 'wcfm_title wcfm_ele', 'custom_attributes' => array( 'required' => true ), 'value' => $store_name ),
																												"store_slug"  => array('label' => __('Page Slug', 'wc-frontend-manager') , 'type' => 'text', 'class' => 'wcfm-text wcfm_ele wcfm_slug_input', 'label_class' => 'wcfm_title wcfm_ele', 'custom_attributes' => array( 'required' => true ), 'value' => urldecode($store_slug) ),
																												"store_email" => array('label' => __('Page Email', 'wc-frontend-manager') , 'type' => 'text', 'class' => 'wcfm-text wcfm_ele', 'label_class' => 'wcfm_title wcfm_ele', 'value' => $store_email ),
																												"phone"       => array('label' => __('Page Phone', 'wc-frontend-manager') , 'type' => 'text', 'placeholder' => '+123456..', 'class' => 'wcfm-text wcfm_ele', 'label_class' => 'wcfm_title wcfm_ele', 'value' => $phone ),
																												), $user_id );
						...
						<?php if( apply_filters( 'wcfm_is_allow_brand_settings', true ) ) { ?>
							...
							<div class="wcfm_vendor_settings_heading"><h2><?php _e( 'Page Brand Setup', 'wc-frontend-manager' ); ?></h2></div>
							<div class="wcfm_clearfix"></div>
							<div class="store_address">		
								<?php
								$settings_fields_general = apply_filters( 'wcfm_marketplace_settings_fields_brand', array(
																																																	"gravatar" => array('label' => __('Page Logo', 'wc-frontend-manager') , 'type' => 'upload', 'class' => 'wcfm-text wcfm_ele', 'label_class' => 'wcfm_title', 'prwidth' => 150, 'value' => $gravatar_url, 'hints' => __( 'Preferred  size is (125x125) pixels.', 'wc-frontend-manager' ) ),
																																																	
																																																	"banner_type" => array('label' => __('Page Banner Type', 'wc-frontend-manager') , 'type' => 'select', 'options' => $store_banner_types, 'class' => 'wcfm-select wcfm_ele wcfm-banner-uploads', 'label_class' => 'wcfm_title', 'value' => $banner_type ),
																																																	"banner" => array('label' => __('Page Banner', 'wc-frontend-manager') , 'type' => 'upload', 'class' => 'wcfm-text wcfm_ele banner_type_upload banner_type_field banner_type_single_img wcfm-banner-uploads', 'label_class' => 'wcfm_title banner_type_field banner_type_single_img', 'prwidth' => 250, 'value' => $banner_url, 'hints' => $banner_help_text ),
																																																	...
																																																	"list_banner_type" => array('label' => __('Page List Banner Type', 'wc-frontend-manager') , 'type' => 'select', 'options' => $store_list_banner_types, 'class' => 'wcfm-select wcfm_ele wcfm-list-banner-uploads', 'label_class' => 'wcfm_title', 'value' => $list_banner_type ),
																																																	"list_banner" => array('label' => __('Page List Banner', 'wc-frontend-manager') , 'type' => 'upload', 'class' => 'wcfm-text wcfm_ele wcfm-banner-uploads list_banner_type_upload list_banner_type_field list_banner_type_single_img', 'label_class' => 'wcfm_title list_banner_type_field list_banner_type_single_img', 'prwidth' => 250, 'value' => $list_banner_url, 'hints' => __( 'This Banner will be visible at Page List Page.', 'wc-frontend-manager' ) ),
																																																	
																																																	"list_banner_video" => array('label' => __('Page List Video Banner', 'wc-frontend-manager') , 'type' => 'text', 'class' => 'wcfm-text wcfm_ele list_banner_type_field list_banner_type_video', 'label_class' => 'wcfm_title list_banner_type_field list_banner_type_video','value' => $list_banner_video, 'hints' => __( 'Insert YouTube video URL.', 'wc-frontend-manager' ) ),
																																																	
																																																	"shop_description" => array('label' => __('Page Description', 'wc-frontend-manager') , 'type' => $wpeditor, 'class' => 'wcfm-textarea wcfm_ele ' . $rich_editor, 'label_class' => 'wcfm_title', 'value' => $shop_description, 'hints' => __( 'This is displayed on your Page page.', 'wc-frontend-manager' ) ),
						...
						<?php if( apply_filters( 'wcfm_is_allow_store_visibility', false ) ) { ?>
							<div class="wcfm_vendor_settings_heading"><h2><?php _e( 'Page Visibility Setup', 'wc-frontend-manager' ); ?></h2></div>
							<div class="wcfm_clearfix"></div>
							<div class="store_address store_visibility_wrap">
							  <?php
								$settings_fields_visibility = apply_filters( 'wcfm_marketplace_settings_fields_visibility', array(
																														"store_name_position" => array( 'label' => __('Page Name Position', 'wc-multivendor-marketplace'), 'type' => 'select', 'options' => array( 'on_banner' => __( 'On Banner', 'wc-multivendor-marketplace' ), 'on_header' => __( 'At Header', 'wc-multivendor-marketplace' ) ), 'class' => 'wcfm-select wcfm_ele', 'label_class' => 'wcfm_title', 'value' => $store_name_position, 'hints' => __( 'Page name position at you Page Page.', 'wc-frontend-manager' ) ),
																														"store_ppp" => array( 'label' => __('Products per page', 'wc-multivendor-marketplace'), 'type' => 'number', 'class' => 'wcfm-text wcfm_ele', 'label_class' => 'wcfm_title', 'value' => $store_ppp, 'attributes' => array( 'min'=> 1, 'step' => 1 ), 'hints' => __( 'No of products at you Page Page.', 'wc-frontend-manager' ) ),
																														"store_hide_email" => array('label' => __( 'Hide Email from Page', 'wc-frontend-manager') , 'type' => 'checkbox', 'class' => 'wcfm-checkbox wcfm_ele', 'label_class' => 'wcfm_title checkbox_title wcfm_ele', 'value' => 'yes', 'dfvalue' => $store_hide_email ),
																														"store_hide_phone" => array('label' => __( 'Hide Phone from Page', 'wc-frontend-manager') , 'type' => 'checkbox', 'class' => 'wcfm-checkbox wcfm_ele', 'label_class' => 'wcfm_title checkbox_title wcfm_ele', 'value' => 'yes', 'dfvalue' => $store_hide_phone ),
																														"store_hide_address" => array('label' => __( 'Hide Address from Page', 'wc-frontend-manager') , 'type' => 'checkbox', 'class' => 'wcfm-checkbox wcfm_ele', 'label_class' => 'wcfm_title checkbox_title wcfm_ele', 'value' => 'yes', 'dfvalue' => $store_hide_address ),
																														"store_hide_map" => array('label' => __( 'Hide Map from Page', 'wc-frontend-manager') , 'type' => 'checkbox', 'class' => 'wcfm-checkbox wcfm_ele', 'label_class' => 'wcfm_title checkbox_title wcfm_ele', 'value' => 'yes', 'dfvalue' => $store_hide_map ),
																														"store_hide_description" => array('label' => __( 'Hide About from Page', 'wc-frontend-manager') , 'type' => 'checkbox', 'class' => 'wcfm-checkbox wcfm_ele', 'label_class' => 'wcfm_title checkbox_title wcfm_ele', 'value' => 'yes', 'dfvalue' => $store_hide_description ),
																														"store_hide_policy" => array('label' => __( 'Hide Policy from Page', 'wc-frontend-manager') , 'type' => 'checkbox', 'class' => 'wcfm-checkbox wcfm_ele', 'label_class' => 'wcfm_title checkbox_title wcfm_ele', 'value' => 'yes', 'dfvalue' => $store_hide_policy ),
																														), $user_id );
				...
				<?php if( apply_filters( 'wcfm_is_allow_store_address', true ) ) { ?>
					...
					<div class="wcfm-container wcfm_marketplace_store_location_settings">
						<div id="wcfm_settings_form_store_location_expander" class="wcfm-content">
							...
							<div class="wcfm_clearfix"></div>
							<div class="wcfm_vendor_settings_heading"><h2><?php _e( 'Page Address', 'wc-frontend-manager' ); ?></h2></div>
							<div class="wcfm_clearfix"></div>
							...
							if ( apply_filters( 'wcfm_is_allow_store_map_location', true ) && ( ( ($wcfm_map_lib == 'google') && !empty( $api_key ) ) || ($wcfm_map_lib == 'leaflet') ) ) {
								?>
								<div class="wcfm_clearfix"></div><br />
								<div class="wcfm_vendor_settings_heading"><h2><?php _e( 'Page Location', 'wc-frontend-manager' ); ?></h2></div>
								<div class="wcfm_clearfix"></div>
				...
				<!-- Background -->
					...
					<div class="page_collapsible" id="wcfm_settings_location_head">
						...
						<?php _e('Background', 'wc-frontend-manager'); ?><span></span>
					</div>
					<div class="wcfm-container wcfm_marketplace_store_location_settings">
						<div id="wcfm_settings_form_store_location_expander" class="wcfm-content">
						
							<div class="wcfm_clearfix"></div>
							<div class="wcfm_vendor_settings_heading"><h2><?php _e( 'Background', 'wc-frontend-manager' ); ?></h2></div>
							<div class="wcfm_clearfix"></div>
							<div class="store_address store_address_wrap"> 
							<!-- start background form-->
									
							<h6>Fill in your information completely and correctly</h6>
										...
										<div class="form-group row">
											...
											Register as a teacher or study center?
											<?php }else{ ?>
											Daftar sebagai guru atau pusat ngaji?	
											<?php }?>	
											
											</label> 
											<div class="col-8">
											<div class="custom-control custom-radio custom-control-inline">
												<input name="type_ngaji" id="type_ngaji_0" type="radio" class="custom-control-input" value="guru_ngaji" required="required" checked> 
												<label for="type_ngaji_0" class="custom-control-label">Guru Ngaji</label>
											</div>
											<div class="custom-control custom-radio custom-control-inline">
												<input name="type_ngaji" id="type_ngaji_1" type="radio" class="custom-control-input" value="sekolah_ngaji" required="required"> 
												<label for="type_ngaji_1" class="custom-control-label">Sekolah ngaji</label>
											</div>
											</div>
										</div>

										<div id="div_guru_ngaji">
												<div class="form-group row">
													<label class="col-4">
													<?php if(get_locale() == 'en_US'){ ?>
														Do you have experience teaching the Quran?
													<?php }else{ ?>
													Adakah anda mempunyai pengalaman mengajar Quran?	
													<?php }?>	
													</label> 
													<div class="col-8">
													<div class="custom-control custom-radio custom-control-inline">
														<input name="pengalaman" id="pengalaman_0" type="radio" class="custom-control-input" value="ya" required="required"> 
														<label for="pengalaman_0" class="custom-control-label">Ya</label>
													</div>
													<div class="custom-control custom-radio custom-control-inline">
														<input name="pengalaman" id="pengalaman_1" type="radio" class="custom-control-input" value="tidak" required="required"> 
														<label for="pengalaman_1" class="custom-control-label">Tidak</label>
													</div>
													</div>
												</div>
												<div class="form-group row">
													<label class="col-4">
													<?php if(get_locale() == 'en_US'){ ?>
													Categories that have taught or want to teach
													<?php }else{ ?>
													...
													<div class="custom-control custom-checkbox custom-control-inline">
														<input name="ajar_siapa[]" id="checkbox_0" type="checkbox" class="custom-control-input" value="Kanak-kanak 3-6" > 
														<label for="checkbox_0" class="custom-control-label">Kanak-kanak (3-6)</label>
													</div>
													<div class="custom-control custom-checkbox custom-control-inline">
														<input name="ajar_siapa[]" id="checkbox_1" type="checkbox" class="custom-control-input" value="Lelaki 7-17" > 
														<label for="checkbox_1" class="custom-control-label">Lelaki (7-17)</label>
													</div>
													<div class="custom-control custom-checkbox custom-control-inline">
														<input name="ajar_siapa[]" id="checkbox_2" type="checkbox" class="custom-control-input" value="Perempuan 7-17" > 
														<label for="checkbox_2" class="custom-control-label">Perempuan (7-17)</label>
													</div>
													<div class="custom-control custom-checkbox custom-control-inline">
														<input name="ajar_siapa[]" id="checkbox_3" type="checkbox"  class="custom-control-input" value="Lelaki >17"> 
														<label for="checkbox_3" class="custom-control-label">Lelaki (>17)</label>
													</div>
													<div class="custom-control custom-checkbox custom-control-inline">
														<input name="ajar_siapa[]" id="checkbox_4" type="checkbox"  class="custom-control-input" value="Perempuan >17"> 
														<label for="checkbox_4" class="custom-control-label">Perempuan (>17)</label>
													</div>
													<div class="custom-control custom-checkbox custom-control-inline">
														<input name="ajar_siapa[]" id="checkbox_5" type="checkbox"  class="custom-control-input" value="Warga Emas >50"> 
														<label for="checkbox_5" class="custom-control-label">Warga Emas(>50)</label>
													</div>
													<div class="custom-control custom-checkbox custom-control-inline">
														<input name="ajar_siapa[]" id="checkbox_6" type="checkbox"  class="custom-control-input" value="Orang Kurang Upaya OKU"> 
														<label for="checkbox_6" class="custom-control-label">Orang Kurang Upaya (OKU)</label>
													</div>
													</div>
												</div>
												<div class="form-group row">
													<label for="Institusi_pengajian" class="col-4 col-form-label">
													<?php if(get_locale() == 'en_US'){ ?>
														Institution of study and level of qualification
													<?php }else{ ?>
														Institusi pengajian dan tahap kelayakan	
													<?php }?>	
													
														
													</label> 
													<div class="col-8">
													<input id="Institusi_pengajian" name="institusi_pengajian" placeholder="E.g : Universiti Al Azhar (Sarjana Muda Syariah)" type="text" class="form-control" required="required">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-4">
													...
													<div class="col-8">
													<div class="custom-control custom-checkbox custom-control-inline">
														<input name="kemahiran_mengajar[]" id="Kemahiran_Mengajar_0" type="checkbox" class="custom-control-input" value="Iqra" > 
														<label for="Kemahiran_Mengajar_0" class="custom-control-label">Iqra</label>
													</div>
													<div class="custom-control custom-checkbox custom-control-inline">
														<input name="kemahiran_mengajar[]" id="Kemahiran_Mengajar_1" type="checkbox" class="custom-control-input" value="Muqaddam" > 
														<label for="Kemahiran_Mengajar_1" class="custom-control-label">Muqaddam</label>
													</div>
													<div class="custom-control custom-checkbox custom-control-inline">
														<input name="kemahiran_mengajar[]" id="Kemahiran_Mengajar_2" type="checkbox" class="custom-control-input" value="Terjemahan Quran" > 
														<label for="Kemahiran_Mengajar_2" class="custom-control-label">Terjemahan Quran</label>
													</div>
													<div class="custom-control custom-checkbox custom-control-inline">
														<input name="kemahiran_mengajar[]" id="Kemahiran_Mengajar_3" type="checkbox" class="custom-control-input" value="Hafazan Quran" > 
														<label for="Kemahiran_Mengajar_3" class="custom-control-label">Hafazan Quran</label>
													</div>
													<div class="custom-control custom-checkbox custom-control-inline">
														<input name="kemahiran_mengajar[]" id="Kemahiran_Mengajar_4" type="checkbox" class="custom-control-input" value="Quran Arabic" > 
														<label for="Kemahiran_Mengajar_4" class="custom-control-label">Quran Arabic</label>
													</div>
													<div class="custom-control custom-checkbox custom-control-inline">
														<input name="kemahiran_mengajar[]" id="Kemahiran_Mengajar_5" type="checkbox" class="custom-control-input" value="Bahasa Arab" > 
														<label for="Kemahiran_Mengajar_5" class="custom-control-label">Bahasa Arab</label>
													</div>
													<div class="custom-control custom-checkbox custom-control-inline">
														<input name="kemahiran_mengajar[]" id="Kemahiran_Mengajar_6" type="checkbox" class="custom-control-input" value="Quran dengan Tajwid" > 
														<label for="Kemahiran_Mengajar_6" class="custom-control-label">Quran dengan Tajwid</label>
													</div>
													<div class="custom-control custom-checkbox custom-control-inline">
														<input name="kemahiran_mengajar[]" id="Kemahiran_Mengajar_7" type="checkbox" class="custom-control-input" value="FarduAin" > 
														<label for="Kemahiran_Mengajar_7" class="custom-control-label">FarduAin</label>
													</div>
													<div class="custom-control custom-checkbox custom-control-inline">
														<input name="kemahiran_mengajar[]" id="Kemahiran_Mengajar_8" type="checkbox" class="custom-control-input" value="Al Hira" > 
														<label for="Kemahiran_Mengajar_8" class="custom-control-label">Al Hira</label>
													</div>
													</div>
												</div>
													<div class="form-group row">
														<label class="col-4">
														<?php if(get_locale() == 'en_US'){ ?>
															Easy -to -use spoken language
													<?php }else{ ?>
														Bahasa pertuturan yang mudah digunakan	
													<?php }?>	
														...
														<div class="col-8">
														<div class="custom-control custom-checkbox custom-control-inline">
															<input name="bahasa_pertuturan[]" id="bahasa_pertuturan_0" type="checkbox" class="custom-control-input" value="Melayu" > 
															<label for="bahasa_pertuturan_0" class="custom-control-label">Melayu</label>
														</div>
														<div class="custom-control custom-checkbox custom-control-inline">
															<input name="bahasa_pertuturan[]" id="bahasa_pertuturan_1" type="checkbox" class="custom-control-input" value="English" > 
															<label for="bahasa_pertuturan_1" class="custom-control-label">English</label>
														</div>
														<div class="custom-control custom-checkbox custom-control-inline">
															<input name="bahasa_pertuturan[]" id="bahasa_pertuturan_2" type="checkbox" class="custom-control-input" value="Arab" > 
															<label for="bahasa_pertuturan_2" class="custom-control-label">Arab</label>
														</div>
														<div class="custom-control custom-checkbox custom-control-inline">
															<input name="bahasa_pertuturan[]" id="bahasa_pertuturan_3" type="checkbox" class="custom-control-input" value="Cina" > 
															<label for="bahasa_pertuturan_3" class="custom-control-label">Cina</label>
														</div>
														</div>
													</div> 
											</div> 
											...
											<div id="div_sekolah_ngaji">
                                                    <div class="form-group row">
                                                        <label class="col-4">
                                                            <?php if(get_locale() == 'en_US'){ ?>
                                                                Are you the owner of a Ngaji School?
                                                                    <?php }else{ ?>
                                                                        Adakah anda pemilik Sekolah Ngaji?	
                                                                    <?php }?>	
                                                        ...
                                                        <div class="col-8">
                                                            <div class="custom-control custom-radio custom-control-inline">
                                                                <input name="sekolah_ngaji" id="radio_0" type="radio" class="custom-control-input" value="Ya"> 
                                                                <label for="radio_0" class="custom-control-label">Ya</label>
                                                            </div>
                                                            <div class="custom-control custom-radio custom-control-inline">
                                                                <input name="sekolah_ngaji" id="radio_1" type="radio" class="custom-control-input" value="Tidak"> 
                                                                <label for="radio_1" class="custom-control-label">Tidak</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <?php if(get_locale() == 'en_US'){ ?>
                                                            Name of the owner of the school
                                                                <?php }else{ ?>
                                                                    Nama pemilik pusat pengajian	
                                                                <?php }?>	
                                                                
                                                        
                                                        </label> 
                                                        <div class="col-8">
                                                        <input id="text" name="sekolah_pemilik" placeholder="luqman nordin" type="text" class="form-control" required="required">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-8">
                                                        <input id="text1" name="sekolah_nama" type="text" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-8">
                                                        <input id="text2" name="sekolah_no_pendaftaran" type="text" class="form-control" required="required">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-4"><?php if(get_locale() == 'en_US'){ ?>
                                                                    Teaching Skills
                                                                <?php }else{ ?>
                                                                    Kemahiran Mengajar	
                                                                <?php }?>	</label> 
                                                        <div class="col-8">
                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                            <input name="kemahiran_mengajar[]" id="checkbox_0" type="checkbox" class="custom-control-input" value="Iqra" > 
                                                            <label for="checkbox_0" class="custom-control-label">Iqra</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                            <input name="kemahiran_mengajar[]" id="checkbox_1" type="checkbox" class="custom-control-input" value="Muqaddam"> 
                                                            <label for="checkbox_1" class="custom-control-label">Muqaddam</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                            <input name="kemahiran_mengajar[]" id="checkbox_2" type="checkbox" class="custom-control-input" value="Terjemahan Quran"> 
                                                            <label for="checkbox_2" class="custom-control-label">Terjemahan Quran</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                            <input name="kemahiran_mengajar[]" id="checkbox_3" type="checkbox" class="custom-control-input" value="Hafazan Quran"> 
                                                            <label for="checkbox_3" class="custom-control-label">Hafazan Quran</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                            <input name="kemahiran_mengajar[]" id="checkbox_4" type="checkbox" class="custom-control-input" value="Quran Arabic"> 
                                                            <label for="checkbox_4" class="custom-control-label">Quran Arabic</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                            <input name="kemahiran_mengajar[]" id="checkbox_5" type="checkbox" class="custom-control-input" value="Bahasa Arab"> 
                                                            <label for="checkbox_5" class="custom-control-label">Bahasa Arab</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                            <input name="kemahiran_mengajar[]" id="checkbox_6" type="checkbox" class="custom-control-input" value="Quran dengan Tajwid"> 
                                                            <label for="checkbox_6" class="custom-control-label">Quran dengan Tajwid</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                            <input name="kemahiran_mengajar[]" id="checkbox_7" type="checkbox" class="custom-control-input" value="FarduAin"> 
                                                            <label for="checkbox_7" class="custom-control-label">FarduAin</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                            <input name="kemahiran_mengajar[]" id="checkbox_8" type="checkbox" class="custom-control-input" value="Al Hira"> 
                                                            <label for="checkbox_8" class="custom-control-label">Al Hira</label>
                                                        </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-8">
                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                            <input name="ajar_siapa[]" id="checkbox1_0" type="checkbox" class="custom-control-input" value="Kanak-kanak (3-6)"> 
                                                            <label for="checkbox1_0" class="custom-control-label">Kanak-kanak (3-6)</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                            <input name="ajar_siapa[]" id="checkbox1_1" type="checkbox" class="custom-control-input" value="Lelaki (7-17)"> 
                                                            <label for="checkbox1_1" class="custom-control-label">Lelaki (7-17)</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                            <input name="ajar_siapa[]" id="checkbox1_2" type="checkbox" class="custom-control-input" value="Perempuan (7-17)"> 
                                                            <label for="checkbox1_2" class="custom-control-label">Perempuan (7-17)</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                            <input name="ajar_siapa[]" id="checkbox1_3" type="checkbox" class="custom-control-input" value="Lelaki (>17)"> 
                                                            <label for="checkbox1_3" class="custom-control-label">Lelaki (>17)</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                            <input name="ajar_siapa[]" id="checkbox1_4" type="checkbox" class="custom-control-input" value="Perempuan (>17)"> 
                                                            <label for="checkbox1_4" class="custom-control-label">Perempuan (>17)</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                            <input name="ajar_siapa[]" id="checkbox1_5" type="checkbox" class="custom-control-input" value="Warga Emas(>50)"> 
                                                            <label for="checkbox1_5" class="custom-control-label">Warga Emas(>50)</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                            <input name="ajar_siapa[]" id="checkbox1_6" type="checkbox" class="custom-control-input" value="Orang Kurang Upaya (OKU)"> 
                                                            <label for="checkbox1_6" class="custom-control-label">Orang Kurang Upaya (OKU)</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                            <input name="ajar_siapa[]" id="checkbox1_7" type="checkbox" class="custom-control-input" value="Muallaf"> 
                                                            <label for="checkbox1_7" class="custom-control-label">Muallaf</label>
                                                        </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-8">
                                                        <input id="text3" name="sekolah_jumlah_guru" type="text" class="form-control" required="required">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-4"><?php if(get_locale() == 'en_US'){ ?>
                                                            Is the owner also a Guru Ngaji?
                                                                <?php }else{ ?>
                                                                    Adakah pemilik juga Guru Ngaji?
                                                                <?php }?>	
                                                                </label> 
                                                        <div class="col-8">
                                                        <div class="custom-control custom-radio custom-control-inline">
                                                            <input name="sekolah_guru_ngaji" id="radio1_0" type="radio" class="custom-control-input" value="Ya" required="required"> 
                                                            <label for="radio1_0" class="custom-control-label">Ya</label>
                                                        </div>
                                                        <div class="custom-control custom-radio custom-control-inline">
                                                            <input name="sekolah_guru_ngaji" id="radio1_1" type="radio" class="custom-control-input" value="Tidak" required="required"> 
                                                            <label for="radio1_1" class="custom-control-label">Tidak</label>
                                                        </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-8">
                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                            <input name="bahasa_pertuturan[]" id="checkbox2_0" type="checkbox" class="custom-control-input" value="Melayu" > 
                                                            <label for="checkbox2_0" class="custom-control-label">Melayu</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                            <input name="bahasa_pertuturan[]" id="checkbox2_1" type="checkbox" class="custom-control-input" value="English" > 
                                                            <label for="checkbox2_1" class="custom-control-label">English</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                            <input name="bahasa_pertuturan[]" id="checkbox2_2" type="checkbox" class="custom-control-input" value="Arab" > 
                                                            <label for="checkbox2_2" class="custom-control-label">Arab</label>
                                                        </div>
                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                            <input name="bahasa_pertuturan[]" id="checkbox2_3" type="checkbox" class="custom-control-input" value="Cina" > 
                                                            <label for="checkbox2_3" class="custom-control-label">Cina</label>
                                                        </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-4"><?php if(get_locale() == 'en_US'){ ?>
                                                            Are you interested in conducting online teaching?
                                                                <?php }else{ ?>
                                                                    Adakah anda berminat untuk menjalankan pengajaran atas talian?
                                                                <?php }?>	
                                                                </label> 
                                                        <div class="col-8">
                                                        <div class="custom-control custom-radio custom-control-inline">
                                                            <input name="sekolah_atas_talian" id="radio2_0" type="radio" class="custom-control-input" value="Ya"> 
                                                            <label for="radio2_0" class="custom-control-label">Ya</label>
                                                        </div>
                                                        <div class="custom-control custom-radio custom-control-inline">
                                                            <input name="sekolah_atas_talian" id="radio2_1" type="radio" class="custom-control-input" value="Tidak"> 
                                                            <label for="radio2_1" class="custom-control-label">Tidak</label>
                                                        </div>
                                                        </div>
                                                    </div> 
                                                </div> 
												...
												<script>
														jQuery( document ).ready( function( $ ) {
															...
															var sekolah_ngaji = $('#div_sekolah_ngaji').children().clone() ;
															var guru_ngaji = $('#div_guru_ngaji').children().clone() ;
															if($('#type_ngaji_0').is(':checked')) { 
																$('#div_sekolah_ngaji').children().remove() ;
															}else{
																$('#div_guru_ngaji').children().remove() ;
															}
															

															$('#type_ngaji_0').click(function() {
																if($('#type_ngaji_0').is(':checked')) { 
																	$('#div_guru_ngaji').prepend(guru_ngaji) ;
																	$('#div_sekolah_ngaji').children().remove() ;
																}
															});

															$('#type_ngaji_1').click(function() {
																if($('#type_ngaji_1').is(':checked')) { 
																	$('#div_sekolah_ngaji').prepend(sekolah_ngaji) ;
																	$('#div_guru_ngaji').children().remove() ;
																}
															});
			  ...
			  <!-- collapsible -->
				<?php if( apply_filters( 'wcfm_is_pref_withdrawal', false ) && apply_filters( 'wcfm_is_allow_billing_settings', true ) ) { ?>
				...
				<!-- collapsible -->
				<?php if( apply_filters( 'wcfm_is_allow_vshipping_settings', false ) && apply_filters( 'wcfm_is_allow_store_shipping', true ) ) { ?>
					<?php 
				...
				<?php if( apply_filters( 'wcfm_is_allow_vseo_settings', false ) ) { ?>
						  ...
						  <div class="wcfm_clearfix"></div>
							...
							<div class="store_address">
								...
								$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_vendors_settings_fields_seo', array(
																																							"wcfmmp-seo-meta-title" => array('label' => __('SEO Title', 'wc-frontend-manager') , 'name' => 'store_seo[wcfmmp-seo-meta-title]', 'type' => 'text', 'class' => 'wcfm-text wcfm_ele', 'label_class' => 'wcfm_title wcfm_ele', 'value' => $wcfmmp_seo_meta_title, 'hints' => __('SEO Title is shown as the title of your Page page', 'wc-frontend-manager') ),
				...
				<?php if( apply_filters( 'wcfm_is_allow_customer_support_settings', false ) ) { ?>
				...
				<?php if( WCFM_Dependencies::wcfmu_plugin_active_check() ) { ?>
					<?php if( apply_filters( 'wcfm_is_pref_vendor_vacation', false ) && apply_filters( 'wcfm_is_allow_vacation_settings', true ) ) { ?>
