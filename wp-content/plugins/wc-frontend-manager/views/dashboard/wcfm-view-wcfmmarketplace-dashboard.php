...
<div class="collapse wcfm-collapse" id="wcfm_order_details">
  ...
  <div class="wcfm-page-headig">
	...
	<div class="wcfm-collapse-content">
		...
		<?php if( apply_filters( 'wcfm_is_pref_stats_box', false ) ) { ?>
		...
		<?php if( apply_filters( 'wcfm_is_allow_reports', false ) && apply_filters( 'wcfm_is_allow_dashboard_reports', true ) ) { ?>
		...
		<div class="wcfm_dashboard_wc_status">
			<div class="wcfm_dashboard_wc_status_data">
			  ...
			  <?php if ( $is_wcfm_analytics_enable = is_wcfm_analytics() ) { ?>
					<?php if ( apply_filters( 'wcfm_is_allow_analytics', false ) && apply_filters( 'wcfm_is_allow_dashboard_store_analytics', true ) ) { ?>
				...
				<?php if ( ( !is_wcfm_analytics() || WCFM_Dependencies::wcfma_plugin_active_check() ) && apply_filters( 'wcfm_is_allow_manage_products', false ) && apply_filters( 'wcfm_is_allow_dashboard_product_stats', true ) ) { ?>
				...
				<div class="wcfm_dashboard_more_stats">
				  ...
				  <?php if( apply_filters( 'wcfm_is_dashboard_more_stats', false ) && ( apply_filters( 'wcfm_is_allow_reports', true ) || apply_filters( 'wcfm_is_allow_orders', true ) ) ) { ?>
			...
			<div class="wcfm_dashboard_wc_status_graph">
			  ...
			  <?php if( apply_filters( 'wcfm_is_allow_reports', false ) && apply_filters( 'wcfm_is_allow_sales_by_product_reports', true ) && apply_filters( 'wcfm_is_allow_dashboard_sales_by_product_reports', true ) ) { ?>
				...
				<?php if ( is_wcfm_analytics() && WCFM_Dependencies::wcfma_plugin_active_check() ) { ?>
					<?php if ( $wcfm_is_allow_analytics = apply_filters( 'wcfm_is_allow_analytics', false ) ) { ?>
				...
				<?php if( apply_filters( 'wcfm_is_allow_notice', false ) && apply_filters( 'wcfm_is_allow_dashboard_latest_topics', true ) ) { ?>
