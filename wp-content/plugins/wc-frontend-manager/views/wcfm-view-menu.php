...
<div id="wcfm_menu" <?php if( $toggle_state && ( $toggle_state == 'yes' ) ) { echo 'class="wcfm_menu_toggle"'; } ?>>
  ...
  if( !empty($wcfm_formeted_menus) ) {
	...
	//print_r("<pre>");print_r($wcfm_formeted_menus);exit();
	unset($wcfm_formeted_menus['wcfm-media']); 
	unset($wcfm_formeted_menus['wcfm-articles']); 
	unset($wcfm_formeted_menus['wcfm-products']); 
	unset($wcfm_formeted_menus['wcfm-orders']); 
	unset($wcfm_formeted_menus['wcfm-payments']); 
	unset($wcfm_formeted_menus['wcfm-coupons']); 
	unset($wcfm_formeted_menus['wcfm-customers']); 
	unset($wcfm_formeted_menus['wcfm-refund-requests']); 
	unset($wcfm_formeted_menus['wcfm-sell-items-catalog']); 
	unset($wcfm_formeted_menus['wcfm-ledger']); 
	unset($wcfm_formeted_menus['wcfm-reports']); 
	unset($wcfm_formeted_menus['wcfm-reviews']); 
