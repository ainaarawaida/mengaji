...
if( $wcfm_is_allow_address_profile = apply_filters( 'wcfm_is_allow_address_profile', false ) ) {
	...
	if( WCFM_Dependencies::wcfmu_plugin_active_check() && wcfm_is_vendor() ) {
		if( !$baddr_1 ) {
			$vendor_verification_data = (array) get_user_meta( $user_id, 'wcfm_vendor_verification_data', false );
	  ...
	  <?php do_action( 'before_wcfm_wcvendors_profile' ); ?>
		...
		<form id="wcfm_profile_form" class="wcfm">
			...
			<div class="wcfm-tabWrap">
				...
				<!-- collapsible -->
				<?php if( $wcfm_is_allow_address_profile = apply_filters( 'wcfm_is_allow_address_profile', false ) ) { ?>
					<div class="page_collapsible" id="wcfm_profile_address_head">
