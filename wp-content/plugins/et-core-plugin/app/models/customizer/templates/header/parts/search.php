...
<div class="et_element et_b_header-search flex align-items-center <?php echo $element_options['wrapper_class']; ?>" <?php echo implode( ' ', $element_options['attributes'] ); ?>>
    ...
    <div class="et-mini-content" style="display: none">
        ...
        <form action="<?php echo esc_url( $url ); ?>" role="search" data-min="<?php echo esc_attr($element_options['min_symbols']); ?>" data-tabs="<?php echo $element_options['search_ajax_with_tabs']; ?>" class="ajax-search-form <?php  esc_attr_e( $element_options['class'] ); ?>" method="get">
			<?php if ( $element_options['is_popup'] ) : ?>
