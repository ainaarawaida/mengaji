...
function etheme_mobile_panel() {
	if ( get_query_var('et_mobile-optimization', true) && !get_query_var('is_mobile', false) ) {
		return;
	}
...
if ( ! function_exists( 'etheme_woocommerce_output_cross_sells_products' ) ) {
	...
	function etheme_woocommerce_output_cross_sells_products() {
		...
		$products_cross_sells_out_of_stock = get_theme_mod('products_cross_sells_out_of_stock_et-desktop', 0);
