...
<!-- <div class="first">
<input style="width: 100%;" type="search" id="search" class="" placeholder="<?php esc_attr_e( 'Search teacher &hellip;', 'wc-multivendor-marketplace' ); ?>" value="<?php echo esc_attr( $search_query ); ?>" name="wcfmmp_store_search" title="<?php esc_attr_e( 'Search teacher &hellip;', 'wc-multivendor-marketplace' ); ?>" />
    </div> -->
    <div class="second">
        <p><?php if(get_locale() == 'en_US'){ ?>
			Teacher or Study Center
	<?php }else{ ?>
	Guru atau Pusat Pengajian 
	<?php }?>
	</p>
		<select id="searchtypengaji" style="width: 100%;" class="" name="searchtypengaji">
			<option value="0">Choose</option>
			<option value="1">Guru Ngaji</option>
			<option value="2">Sekolah Ngaji</option>
		</select>
    </div>
    <div class="third">
        <p><?php if(get_locale() == 'en_US'){ ?>
	...
	<?php }?>
		...
		<select style="width: 100%;" class="" name="categoryStudent" id="categoryStudent">
			<option value="0">Choose</option>
			<option value="1">Kanak-kanak (3-6)</option>
			<option value="2">Lelaki (7-17)</option>
			<option value="3">Perempuan (7-17)</option>
			<option value="4">Lelaki (>17)</option>
			<option value="5">Perempuan (>17)</option>
			<option value="6">Warga Emas(>50)</option>
			<option value="7">Orang Kurang Upaya (OKU)</option>
		</select>
    </div>
	<div class="third">
        <p><?php if(get_locale() == 'en_US'){ ?>
	...
	<?php }?>	
		...
		<select style="width: 100%;" class="" name="teachingSkills" id="teachingSkills">
			<option value="0">Choose</option>
			<option value="Iqra">Iqra</option>
			<option value="Muqaddam">Muqaddam</option>
			<option value="Terjemahan Quran">Terjemahan Quran</option>
			<option value="Hafazan Quran">Hafazan Quran</option>
			<option value="Quran Arabic">Quran Arabic</option>
			<option value="Bahasa Arab">Bahasa Arab</option>
			<option value="Quran dengan Tajwid">Quran dengan Tajwid</option>
			<option value="FarduAin">FarduAin</option>
