...
class WCFMmp_Store_Setup {
	...
	public function wcfmmp_store_setup() {
		...
		$default_steps = array(
				...
				'store' => array(
					'name' => __('Page', 'wc-multivendor-marketplace'),
					'view' => array($this, 'wcfmmp_store_setup_store'),
					'handler' => array($this, 'wcfmmp_store_setup_store_save')
				),
				'learning_subject' => array(
					'name' => __('Background', 'wc-multivendor-marketplace'),
					'view' => array($this, 'wcfmmp_store_setup_learning_subject'),
					'handler' => array($this, 'wcfmmp_store_setup_learning_subject_save')
				),
				// 'payment' => array(
	...
	public function wcfmmp_store_setup_header() {
		...
		<html <?php language_attributes(); ?>>
			...
			<body class="wc-setup wcfm-store-setup wp-core-ui">
			 <h1 id="wc-logo"><a target="_blank" href="<?php echo site_url(); ?>"><img width="75" height="75" src="<?php echo $logo_image_url; ?>" alt="<?php echo get_bloginfo('title'); ?>" /><span><?php _e( 'Page Setup', 'wc-multivendor-marketplace' ); ?></span></a></h1>
			<?php
	}
	...
	public function wcfmmp_store_setup_introduction() {
		...
		<p><?php echo apply_filters( 'wcfm_store_setup_welcome_message', sprintf( __('Thank you for choosing %s! This quick setup wizard will help you to configure the basic settings and you will have your page ready in no time.', 'wc-multivendor-marketplace'), get_bloginfo('title') ) ); ?></p>
		<p><?php echo esc_html( apply_filters( 'wcfm_store_setup_welcome_footer', __( "If you don't want to go through the wizard right now, you can skip and return to the dashboard. You may setup your page from dashboard &rsaquo; setting anytime!", 'wc-multivendor-marketplace' ) ) ); ?></p>
	...
	public function wcfmmp_store_setup_store() {
		...
		$banner_help_text = sprintf(
				__('Upload a banner for your page. Banner size is (%sx%s) pixels.', 'wc-frontend-manager' ),
		...
		?>
		<h1><?php esc_html_e('Page setup', 'wc-multivendor-marketplace'); ?></h1>
		<form method="post">
			<table class="form-table">
				<?php
					$settings_fields_general = apply_filters( 'wcfm_marketplace_settings_fields_general', array(
																																													"gravatar"    => array('label' => __('Page Logo', 'wc-frontend-manager') , 'type' => 'upload', 'in_table' => 'yes', 'name' => 'vendor_data[gravatar]', 'class' => 'wcfm-text wcfm_ele', 'label_class' => 'wcfm_title', 'prwidth' => 150, 'value' => $gravatar_url ),
																																													...
																																													"store_name"  => array('label' => __('Page Name', 'wc-frontend-manager') , 'type' => 'text', 'in_table' => 'yes', 'name' => 'vendor_data[store_name]', 'class' => 'wcfm-text wcfm_ele', 'label_class' => 'wcfm_title wcfm_ele', 'value' => $store_name ),
																																													"store_email" => array('label' => __('Page Email', 'wc-frontend-manager') , 'type' => 'text', 'in_table' => 'yes', 'name' => 'vendor_data[store_email]', 'class' => 'wcfm-text wcfm_ele', 'label_class' => 'wcfm_title wcfm_ele', 'value' => $store_email ),
																																													"phone"       => array('label' => __('Page Phone', 'wc-frontend-manager') , 'type' => 'text', 'in_table' => 'yes', 'name' => 'vendor_data[phone]', 'placeholder' => '+123456..', 'class' => 'wcfm-text wcfm_ele', 'label_class' => 'wcfm_title wcfm_ele', 'value' => $phone ),
																																													), $user_id );
					...
					if( apply_filters( 'wcfm_is_allow_store_address', true ) ) {
						$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_marketplace_settings_fields_address', array(
																																															"street_1" => array('label' => __('Page Address 1', 'wc-multivendor-marketplace'), 'placeholder' => __('Street address', 'wc-frontend-manager'), 'name' => 'vendor_data[address][street_1]', 'type' => 'text', 'in_table' => 'yes', 'class' => 'wcfm-text wcfm_ele', 'label_class' => 'wcfm_title wcfm_ele', 'value' => $street_1 ),
																																															"street_2" => array('label' => __('Page Address 2', 'wc-multivendor-marketplace'), 'placeholder' => __('Apartment, suite, unit etc. (optional)', 'wc-frontend-manager'), 'name' => 'vendor_data[address][street_2]', 'type' => 'text', 'in_table' => 'yes', 'class' => 'wcfm-text wcfm_ele', 'label_class' => 'wcfm_title wcfm_ele', 'value' => $street_2 ),
																																															"city" => array('label' => __('Page City/Town', 'wc-multivendor-marketplace'), 'placeholder' => __('Town / City', 'wc-frontend-manager'), 'name' => 'vendor_data[address][city]', 'type' => 'text', 'in_table' => 'yes', 'class' => 'wcfm-text wcfm_ele', 'label_class' => 'wcfm_title wcfm_ele', 'value' => $city ),
																																															"zip" => array('label' => __('Page Postcode/Zip', 'wc-multivendor-marketplace'), 'placeholder' => __('Postcode / Zip', 'wc-frontend-manager'), 'name' => 'vendor_data[address][zip]', 'type' => 'text', 'in_table' => 'yes', 'class' => 'wcfm-text wcfm_ele', 'label_class' => 'wcfm_title wcfm_ele', 'value' => $zip, 'attributes' => array( 'min' => '1', 'step'=> '1' ) ),
																																															"country" => array('label' => __('Page Country', 'wc-multivendor-marketplace'), 'name' => 'vendor_data[address][country]', 'type' => 'country', 'in_table' => 'yes', 'wrapper_class' => 'store_address_wrap', 'class' => 'wcfm-select wcfm_ele', 'label_class' => 'wcfm_title wcfm_ele', 'attributes' => array(  'style' => 'width:100%' ), 'custom_attributes' => array( 'required' => true ), 'value' => $country ),
																																															"state" => array('label' => __('Page State/County', 'wc-multivendor-marketplace'), 'name' => 'vendor_data[address][state]', 'type' => 'select', 'in_table' => 'yes', 'class' => 'wcfm-select wcfm_ele', 'label_class' => 'wcfm_title wcfm_ele', 'custom_attributes' => array( 'required' => true ), 'attributes' => array(  'style' => 'width:100%' ),  'options' => $state_options, 'value' => $state ),
																																															), $user_id ) );
						...
						if ( apply_filters( 'wcfm_is_allow_store_map_location', true ) && ( ( ($wcfm_map_lib == 'google') && !empty( $api_key ) ) || ($wcfm_map_lib == 'leaflet') ) ) {
							$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_marketplace_settings_fields_location', array(
																																																				...
																																																				"withdrawal_setting_break_1" => array( 'label' => __('Page Location', 'wc-multivendor-marketplace'), 'type' => 'html', 'in_table' => 'yes', 'value' => '<div class="wcfm-marketplace-google-map" id="wcfm-marketplace-map"></div>' ),
			...
			if( apply_filters( 'wcfm_is_allow_store_description', true ) ) {
				$WCFM->wcfm_fields->wcfm_generate_form_field( apply_filters( 'wcfm_marketplace_settings_fields_brand', array(
					"shop_description" => array('label' => __('Page Description', 'wc-frontend-manager') , 'type' => 'wpeditor', 'class' => 'wcfm-textarea wcfm_ele wcfm_wpeditor', 'label_class' => 'wcfm_title', 'value' => $shop_description, 'hints' => __( 'This is displayed on your shop page.', 'wc-frontend-manager' ) ),
					), $user_id ) );
			}
			?>
			<p class="wc-setup-actions step">
	...
	public function wcfmmp_store_setup_ready() {
		...
		<p><?php echo esc_html( apply_filters( 'wcfm_store_setup_complete_message', __( "Your page is ready. It's time to experience the things more Easily and Peacefully. Add your classes and your skill, have fun!!", 'wc-multivendor-marketplace' ) ) ); ?></p>
		</div>
	...
	public function wcfmmp_store_setup_learning_subject() {
		global $WCFM, $WCFMmp;
		...
		?>
		<h1>Background</h1>
		<h3>Fill in your information completely and correctly</h3>
		<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css"> 
		<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">

		<form class="notranslate" method="post">
  ...
  <div class="form-group row">
	...
	public function wcfmmp_store_setup_learning_subject_save() {
		...
		$tableName = $wpdb->prefix."mengaji" ; 
		$data_update = array('user_id' => $user_id
		,'type_ngaji' => $wpdb->esc_like($_POST['type_ngaji']) 
		,'pengalaman' => $wpdb->esc_like($_POST['pengalaman'])  
		,'ajar_siapa' => $wpdb->esc_like(implode('#',$_POST['ajar_siapa']))  
		,'institusi_pengajian' => $wpdb->esc_like($_POST['institusi_pengajian'])  
		,'kemahiran_mengajar' => $wpdb->esc_like(implode('#',$_POST['kemahiran_mengajar']))  
		,'bahasa_pertuturan' => $wpdb->esc_like(implode('#',$_POST['bahasa_pertuturan']))  
		,'sekolah_ngaji' => $wpdb->esc_like($_POST['sekolah_ngaji'])  
		,'sekolah_pemilik' => $wpdb->esc_like($_POST['sekolah_pemilik'])  
		,'sekolah_nama' => $wpdb->esc_like($_POST['sekolah_nama'])  
		,'sekolah_no_pendaftaran' => $wpdb->esc_like($_POST['sekolah_no_pendaftaran'])  
		,'sekolah_jumlah_guru' => $wpdb->esc_like($_POST['sekolah_jumlah_guru'])  
		,'sekolah_guru_ngaji' => $wpdb->esc_like($_POST['sekolah_guru_ngaji'])  
		,'sekolah_atas_talian' => $wpdb->esc_like($_POST['sekolah_atas_talian'])  
		);
