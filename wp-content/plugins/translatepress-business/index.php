        ...
        function trp_main_plugin_notice(){
            if( !defined( 'TRP_PLUGIN_VERSION' ) ){
                echo '<div class="notice notice-info is-dismissible"><p>';
                    printf(__('Please install and activate the TranslatePress - Multilingual plugin', 'translatepress-multilingual'));
                echo '</p></div>';
            }
            else{
                if( version_compare( TRP_PLUGIN_VERSION, '2.0.5', '<' ) ){
                    echo '<div class="notice notice-info is-dismissible"><p>';
                    printf(__('Please update the TranslatePress - Multilingual plugin to version 2.0.5 at least for %s to work properly', 'translatepress-multilingual'), TRANSLATE_PRESS );
                    echo '</p></div>';
                }
            }
        }
