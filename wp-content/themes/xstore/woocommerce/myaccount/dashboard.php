...
?>
	...
	<div class="MyAccount-dashboard-buttons">
		...
		<a href="<?php echo esc_url( wc_get_endpoint_url( 'maklumat-khairat' ) ); ?>" class="btn black big"><i class="et-icon et_b-icon et-internet"></i><span><?php echo esc_html__('Maklumat Khairat', 'xstore'); ?></span></a>
	...
	if ( $products_type != 'none' ) :
        ...
        $slider_args = array(
            'title' => esc_html__('Mati Itu Pasti', 'xstore'),
            'large'            => 3,
            'notebook'         => 3,
