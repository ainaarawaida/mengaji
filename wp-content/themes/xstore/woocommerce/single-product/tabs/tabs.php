...
if ( ( ! empty( $product_tabs ) || $et_tabs['check'] ) && etheme_get_option('tabs_type', 'tabs-default') != 'disable' ) : $i=0; ?>
...
<?php endif ?>
    <div class="woocommerce-tabs wc-tabs-wrapper tabs <?php etheme_option('tabs_type'); ?> <?php echo (etheme_get_option('tabs_scroll', 0) && etheme_get_option('tabs_type', 'tabs-default') == 'accordion') ? 'tabs-with-scroll' : ''; ?>">
