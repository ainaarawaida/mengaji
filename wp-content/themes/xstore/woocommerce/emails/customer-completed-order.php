...
<p><?php esc_html_e( 'Anda telah menjadi Ahli Sah Khairat Pudina.', 'woocommerce' ); ?></p>
<p>Sila Lihat di Akaun Anda untuk mendapatkan Kad Ahli Digital di <a href="<?php echo home_url() ; ?>/my-account/">sini</a></p>

<?php 

//print_r("<pre>");print_r($email->recipient); 
$user = get_user_by( 'email', $email->recipient );
// $usermeta = get_user_meta ($user->ID);
// $subdata = wcs_get_users_subscriptions($user->ID);

// foreach($subdata AS $key => $val){
// 	$datestart = date("d/m/Y", strtotime($val->schedule_start)) ;
// 	$dateend = date("d/m/Y", strtotime($val->schedule_next_payment))  ;
// 	$mystatus = $val->status ;
// }

// $myid = $user->ID ;
// $no_kad_pengenalan = $usermeta['no_kad_pengenalan'][0] ;
// $first_name = $usermeta['first_name'][0] ;
// $billing_address_1 = $usermeta['billing_address_1'][0] ;
// $mystatus = isset($mystatus) && $mystatus == 'active' ? 'Aktif' : 'Tidak Aktif' ; 
// $tarikh_lahir = $usermeta['tarikh_lahir'][0] ;

//print_r("<pre>");print_r($user); 
// print_r("<pre>");print_r($subdata); 
...
<div class="card">
   ...
   <div class="card-details">
      ...
      <div class="occupation"><?php echo $user->user_email ; ?></div>
      
      <div class="card-about">
         <div class="item">
            <span class="value">Tarikh Lahir</span>
            <span class="label"><?php echo $tarikh_lahir ; ?></span>
         </div>
         <div class="item">
            <span class="value">IC </span>
            <span class="label"><?php echo $no_kad_pengenalan ; ?></span>
         </div>
      ...
      <div class="card-about">
         <div class="item">
            ...
            <span class="label"><?php echo $datestart ; ?></span>
         </div>
         <div class="item">
            <span class="value">Tamat </span>
            <span class="label"><?php echo $dateend ; ?></span>
         </div>
      ...
      <div class="skills">
         ...
         <span class="label"><?php echo $billing_address_1 ; ?></span>
      </div>
   </div>
</div>
...
/* http://test2.msia-my.com/wp-content/uploads/2021/07/Untitled2.png */
...
.card2 { 
   ...
   background: url('http://test2.msia-my.com/wp-content/uploads/2021/07/Untitled2.png');
   background-size:100% 100%;
